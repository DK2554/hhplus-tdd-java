    ...
    public class PointServiceTest {
        ...
        @Test
        @DisplayName("포인트사용_금액이_0원미만이면_IllegalArgumentException예외가_발생하며_사용금액은_0보다_커야합니다를반환한다")
        ...
        @Test
        @DisplayName("특정사용자가_잔금이100인상태에서_101인금액을_사용하려고하면_IllegalArgumentException예외를발생하며_메세지는_잔고에_금액이_부족합니다를_반환한다")
